CREATE TABLE `sys_project_basic_info` (
    ...
    `reporter_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '填报人',
    `reporter_phone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '填报人联系方式',
    `firm_name` varchar(64) DEFAULT NULL COMMENT '填报人公司',
    `subordinate_name` varchar(64) DEFAULT NULL COMMENT '下属单位名称',
    `officer` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '责任人',
    ...
    PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 2 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '项目基础信息表';
...
CREATE TABLE `sys_project_info` (
    ...
    PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 2 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '单位及人员信息表';
...
CREATE TABLE `sys_page_info` (
    ...
    `delete_time` datetime DEFAULT NULL COMMENT 'Delete Time',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '页面信息';
...
CREATE TABLE `sys_page_setting_table` (
    ...
    `delete_time` datetime DEFAULT NULL COMMENT 'Delete Time',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '页面和动态表格对应关系';
